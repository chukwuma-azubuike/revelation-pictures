...
import linkRouter from "../../hooks/linkRouter"

export default function Footer() {

    const handleRoute = (route) => {
        alert(`/${route.target.id}`)
        linkRouter(`/${route.target.id}`)
    }
        ...
        <nav className='bg-black text-white md:px-9 lg:px-28 xl:px-52 box-border relative w-full'>
            ...
            <div className='text-6xl relative flex bottom-0 box-border font-black pt-16 pb-8 xl:text-8xl'>
                <ul className='justify-between w-full md:flex'>
                    <Link to='/projects' >
                        <li id='projects' className='flex cursor-pointer items-center px-8 md:block hover:text-accent-300 transition-colors duration-300'>
                            <h1 className='my-3 mr-10'>01</h1>
                            <h1 className='font-thin text-base w-min' >ALL PROJECTS</h1>
                        </li>
                    </Link>
                    <Link to='/talent'>
                        <li id='talent' className='flex items-center px-8 md:block hover:text-accent-300 transition-colors duration-300'>
                            <h1 className='my-3 mr-10'>02</h1>
                            <h1 className='font-thin text-base w-min'>TALENT</h1>
                        </li>
                    </Link>
                    <Link to='/about'>
                        <li id='about' className='flex items-center px-8 md:block hover:text-accent-300 transition-colors duration-300'>
                            <h1 className='my-3 mr-10'>03</h1>
                            <h1 className='font-thin text-base w-min'>ABOUT US</h1>
                        </li>
                    </Link>
                    <Link to='/contact' >
                        <li id='contact' className='flex items-center px-8 md:block hover:text-accent-300 transition-colors duration-300'>
